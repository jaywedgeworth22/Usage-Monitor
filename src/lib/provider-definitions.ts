...
const DEFINITIONS = [
  ...
  { name: "deno", displayName: "Deno Deploy", type: "builtin", category: "Developer Platform", lifecycle: "retired", helpNote: "Tracks Deno Deploy organization metrics (HTTP requests, CPU time, memory time, traffic, KV reads/writes), quotas, and subscription plan status via Deno Deploy API or pushed telemetry.", needsConfig: { fields: [{ key: "orgSlug", label: "Organization slug (optional)", placeholder: "congress-trade" }] } },
