...
Last verified: 2026-07-13. Links below are provider-owned documentation.
...
| Google Gemini API | Calendar-month net Gemini API cost, credits, project/SKU usage and report-through time from Standard Cloud Billing export | `billingDataset` (`project.dataset`) plus encrypted read-only `serviceAccountJson`; optional project/table override only when discovery is ambiguous | [Standard export schema](https://docs.cloud.google.com/billing/docs/how-to/export-data-bigquery-tables/standard-usage) and [query IAM](https://docs.cloud.google.com/bigquery/docs/running-queries) |
